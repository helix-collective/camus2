...
export interface ToolConfig {
   ...
   */
  applicationConfig: sys_types.Maybe<BlobStoreConfig>;
  /**
...
export function makeToolConfig(
  ...
  return {
    ...
    applicationConfig: input.applicationConfig === undefined ? {kind : "nothing"} : input.applicationConfig,
